...
import {Id, Market, ILending8} from "../../../interfaces/ILending8.sol";
...
import {UtilsLib as Lending8UtilsLib} from "../../../lib/UtilsLib.sol";
...
library AdaptiveCurveIrmLib {
    ...
    using Lending8MathLib for uint256;
    using Lending8MathLib for uint128;
    using SharesMathLib for uint256;
    using Lending8UtilsLib for uint256;

    /// @dev Same as the Lending8BalancesLib.expectedMarketBalances function, but takes the market id as input.
    ...
    function expectedMarketBalances(address lending8, bytes32 id, address adaptiveCurveIrm)
        internal
        view
        returns (uint256, uint256, uint256, uint256)
    {
        Market memory market = ILending8(lending8).market(Id.wrap(id));
