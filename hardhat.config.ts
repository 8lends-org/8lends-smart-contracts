...
const config: HardhatUserConfig = {
    ...
    abiExporter: {
        ...
        clear: true,
        flat: true,
        only: [':Fundraise$', ':RewardSystem$', ':Treasury$', ':Token$', ':ManagerRegistry$', ':Rewards2$', ':Market$', ':Lending8$', ':Oracle$', ':AdaptiveCurveIrm$', ':LimitedSeller$', ':BTC8L$', ':EscrowFactory$', ':AmlEscrow$'],
        spacing: 2,
        format: 'json',
    },
    etherscan: {
