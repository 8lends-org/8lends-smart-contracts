...
/// @title Lending8StorageLib
/// @author 8lends
/// @custom:contact security@8lends.com
/// @notice Helper library exposing getters to access Lending8 storage variables' slot.
/// @dev This library is not used in Lending8 itself and is intended to be used by integrators.
library Lending8StorageLib {
    /* SLOTS (layout: DOMAIN_SEPARATOR at 0; owner in OwnableUpgradeable ERC-7201 namespace) */

    uint256 internal constant DOMAIN_SEPARATOR_SLOT = 0;
