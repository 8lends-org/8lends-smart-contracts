 ...
 * 
 * Usage: PERCENT=26 npx hardhat run scripts/22_set_additional_unlock_percentage.ts --network base
 * 
...
async function main(): Promise<void> {
    ...
    if (!PERCENT) {
        throw new Error("❌ PERCENT is not set. Usage: PERCENT=26 npx hardhat run scripts/22_set_additional_unlock_percentage.ts");
    }
